...
for k in content_ratings:
    c_ratings_prop = content_ratings[k] / total_number_of_apps
    c_ratings_proportions[k] = c_ratings_prop
    c_ratings_percent = c_ratings_prop * 100
    c_ratings_percentages[k] = c_ratings_percent
