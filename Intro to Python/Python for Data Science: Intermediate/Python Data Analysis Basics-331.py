...
full = template.format(artist, birth_year)
print(full)
...
def artist_summary(artist):
    ...
    text = template.format(num_artworks, artist)
    print(text)
...
for country in pop_millions:
    text = template.format(country[0],country[1])
    print(text)
