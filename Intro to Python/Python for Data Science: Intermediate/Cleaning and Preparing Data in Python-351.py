...
for row in moma:
    begin = clean_and_convert(row[3])
    row[3] = begin
    end = clean_and_convert(row[4])
    row[4] = end
...
for n in stripped_test_data:
    cleaned_data = process_date(n)
    processed_test_data.append(cleaned_data)
